...
import resources.components.menu.mode.LightDarkMode;
...
import resources.components.menu.mode.ToolBarAccentColor;
...
public class Menu extends JPanel {
    ...
    private final String menuItems[][] = {
        {"~PRINCIPAL~"},
        {"Inicio"},
        {"Inventario", "Equipos", "Componentes", "Manteniminetos"},
        {"Calendario"},
        {"~OTROS~"},
        {"Reportes", "General", "Trimestral", "Estado"},};
    ...
    private final String headerName = " OPTIMUS";
    ...
    private void init() {
        ...
        header.setIcon(new ImageIcon(System.getProperty("user.dir") + "/src/main/java/resources/images/unan-small-logo.png"));
