...
import app.Interfaces.EventDateChooser;
...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdForward = new resources.components.datechooser.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new resources.components.datechooser.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new resources.components.datechooser.Button();
        cmdPrevious = new resources.components.datechooser.Button();
        slide = new resources.components.datechooser.Slider();
        ...
        header.setBackground(new java.awt.Color(36, 104, 155));
        ...
        DateOptions.setBackground(new java.awt.Color(36, 104, 155));
    ...
    private resources.components.datechooser.Button cmdForward;
    private resources.components.datechooser.Button cmdMonth;
    private resources.components.datechooser.Button cmdPrevious;
    private resources.components.datechooser.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private resources.components.datechooser.Slider slide;
